<%-- 
    Document   : index.jsp
    Created on : 14/03/2022, 12:42:06 PM
    Author     : Ivan
--%>
    ...
    <body>
        ...
        <ul class="navegacion">
            ...
            <li class="enlace" id="consultas">
                ...
                <div class="submenu">
                    <a href="Controlador_graficas?accion=poblaciontotal">Población total</a>
                    <a href="#">Visitas Total</a>
                    <a href="Controlador_graficas?accion=grafica">Estadísticas por sexo</a>
                </div>
            </li>
